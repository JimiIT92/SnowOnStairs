...
execute if score #base_color snow.model_id matches -1 if block ~ ~ ~ #minecraft:slabs[type=bottom] run function snow_on_stairs:snow/spawn/slabs
execute if score #base_color snow.model_id matches -1 if block ~ ~ ~ #minecraft:stairs[half=bottom] run function snow_on_stairs:snow/spawn/stairs
