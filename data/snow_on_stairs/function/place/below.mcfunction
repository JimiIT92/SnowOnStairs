...
$execute positioned $(x) $(y) $(z) at @e[tag=snow_on_stairs.snow,limit=1,distance=..0.1,type=minecraft:block_display] as @e[tag=snow_on_stairs.snow,limit=1,distance=..0.1,type=minecraft:block_display] run tp ^-0.5001 ^-0.5 ^-0.5001